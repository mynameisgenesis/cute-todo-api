...
type ComplexityRoot struct {
	Mutation struct {
		CreateTask   func(childComplexity int, title string, priority string) int
...
type MutationResolver interface {
	CreateTask(ctx context.Context, title string, priority string) (*model.Task, error)
	UpdateStatus(ctx context.Context, id string, status string) (*model.Task, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createTask":
		...
		return e.ComplexityRoot.Mutation.CreateTask(childComplexity, args["title"].(string), args["priority"].(string)), true
	case "Mutation.updateStatus":
		if e.ComplexityRoot.Mutation.UpdateStatus == nil {
			break
		}
		...
		return e.ComplexityRoot.Mutation.UpdateStatus(childComplexity, args["id"].(string), args["status"].(string)), true
...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["title"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "priority", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["priority"] = arg1
...
func (ec *executionContext) _Mutation_createTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.Resolvers.Mutation().CreateTask(ctx, fc.Args["title"].(string), fc.Args["priority"].(string))
		},
		nil,
		ec.marshalNTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_updateStatus(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().UpdateStatus(ctx, fc.Args["id"].(string), fc.Args["status"].(string))
		},
		nil,
		ec.marshalNTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask,
		true,
...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTask2ᚕᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTaskᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_task(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalNTask2cuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v model.Task) graphql.Marshaler {
	return ec._Task(ctx, sel, &v)
}

func (ec *executionContext) marshalNTask2ᚕᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Task) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOTask2ᚖcuteᚑtodoᚑapiᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Task(ctx, sel, v)
